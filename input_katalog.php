...
<?php
    ...
    if(isset($_POST['kirim'])){
        ...
        if(move_uploaded_file($tmp,'gambar_katalog/'.$gambar_baru)){
            $query = "INSERT INTO katalog (kode_katalog, nama_katalog, warna_katalog, jenis_katalog, foto_katalog)
                        VALUES ('$kode_katalog', '$nama_katalog', '$warna_katalog', '$jenis_katalog', '$gambar')";
